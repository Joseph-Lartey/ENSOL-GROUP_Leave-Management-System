                ...
                <div class="card">
                    <div class="card-body" style="padding: 0;">
                        <div class="requests-table">
                            ...
                            <div class="request-row" data-request-id="5">
                                <div class="request-icon annual">📅</div>
                                <div class="request-details">
                                    <div class="request-title">Annual Leave</div>
                                    <div class="request-meta">HR Approved</div>
                                ...
                                <div class="request-date">20.10.2025</div>
                                <div class="request-actions">
                                    <button class="btn-delete" onclick="deleteRequest(5)">Delete</button>
                                    <button class="btn-edit" onclick="editRequest(5)">Edit</button>
                                </div>
                            </div>

                            <div class="request-row" data-request-id="6">
                                <div class="request-icon annual">📅</div>
                                <div class="request-details">
                                    <div class="request-title">Annual Leave</div>
                                    <div class="request-meta">HR Approved</div>
                                ...
                                <div class="request-date">20.10.2025</div>
                                <div class="request-actions">
                                    <button class="btn-delete" onclick="deleteRequest(6)">Delete</button>
                                    <button class="btn-edit" onclick="editRequest(6)">Edit</button>
                                </div>
                            </div>
                        </div>
                    </div>
