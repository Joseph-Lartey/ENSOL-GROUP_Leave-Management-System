...
function handleLoginSubmit(e) {
    ...
    setTimeout(() => {
        ...
        alert('Login functionality will be connected to API');
    }, 1500);
}
...
function handleSignupSubmit(e) {
    ...
    // Simulate API call
    console.log('Sign up attempt:', { firstName, lastName, email, subsidiary, department });
    ...
    setTimeout(() => {
        ...
        alert('Sign up functionality will be connected to API');
    }, 1500);
}
